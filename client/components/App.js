          ...
          <div className="router-container">
            ...
            <aside className="aside">
              <ul className="aside__nav">
                <li>
                  <Link
                    className="aside__nav__item aside__nav__item--popular"
                    to="/"
                  >
                    Popular
                  </Link>
                ...
                <li>
                  <Link
                    className="aside__nav__item aside__nav__item--top-rated"
                    to="/top-rated"
                  >
                    Top rated
                  </Link>
                ...
                <li>
                  <Link
                    className="aside__nav__item aside__nav__item--new-release"
                    to="/new-release"
                  >
                    New release
                  </Link>
                ...
                <li>
                  <Link
                    className="aside__nav__item aside__nav__item--recommend-for-you"
